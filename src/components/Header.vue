<template>
    <div class="relative" >
        <div class="flex flex-row flex-wrap justify-between lg:hidden">
            <a href="#">
                <h1 class="
                                text-5xl 
                                font-bold 
            ...
            <div class="flex flex-row">
                <button class=" mr-2 bg-gray-200 p-0 w-9 h-9 rounded-full flex flex-row items-center justify-center">
